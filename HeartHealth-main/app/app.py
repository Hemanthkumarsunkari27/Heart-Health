...
# Connect to MongoDB
client = MongoClient("mongodb+srv://hemu64145:cYl8AmHCFsqxqtd3@cluster0.ak1l4o8.mongodb.net/test?retryWrites=true&w=majority")
db = client["predictions"]
collection = db["user_predictions"]

# Configure Generative AI
genai.configure(api_key="AIzaSyC_7MksqbB9P-GCeXrhGgvZPgnSdjoux0U")
